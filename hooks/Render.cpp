...
void ImGuiRendering::BeginScene()
{
	...
	if (m_engine()->IsInGame() && m_engine()->IsConnected())
	{
		...
		if (background == nullptr)
			D3DXCreateTextureFromFileInMemoryEx(dev, &bg, sizeof(bg), siz.x, siz.y, D3DX_DEFAULT, D3DUSAGE_DYNAMIC, D3DFMT_UNKNOWN, D3DPOOL_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, NULL, NULL, &background);
