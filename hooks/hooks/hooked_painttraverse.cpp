...
void __fastcall hooks::hooked_painttraverse(void* ecx, void* edx, vgui::VPANEL panel, bool force_repaint, bool allow_force)
{
	...
	if (set_console)
	{
		...
		m_cvar()->ConsoleColorPrintf(Color(255, 255, 255), "\n");
		m_cvar()->ConsoleColorPrintf(Color(255, 255, 255), " /$$       /$$$$$$$$ /$$$$$$$$ /$$   /$$  /$$$$$$  /$$   /$$ /$$$$$$$$  /$$$$$$  /$$$$$$$$ \n");
		m_cvar()->ConsoleColorPrintf(Color(255, 255, 255), "| $$  | $$_____/| $$_____/| $$$ | $$ / $$__  $$ | $$ | $$ | $$_____/ /$$__  $$ | __  $$__  \n");
		m_cvar()->ConsoleColorPrintf(Color(255, 255, 255), "| $$      | $$      | $$      | $$$$| $$| $$  \__/| $$  | $$| $$      | $$  \ $$   | $$   \n");
		m_cvar()->ConsoleColorPrintf(Color(255, 255, 255), "| $$      | $$$$$   | $$$$$   | $$ $$ $$| $$      | $$$$$$$$| $$$$$   | $$$$$$$$   | $$   \n");
		m_cvar()->ConsoleColorPrintf(Color(255, 255, 255), "| $$      | $$__/   | $$__/   | $$  $$$$| $$      | $$__  $$| $$__/   | $$__  $$   | $$   \n");
		m_cvar()->ConsoleColorPrintf(Color(255, 255, 255), "| $$      | $$      | $$      | $$\  $$$| $$    $$| $$  | $$| $$      | $$  | $$   | $$   \n");
		m_cvar()->ConsoleColorPrintf(Color(255, 255, 255), "| $$$$$$$$| $$$$$$$$| $$$$$$$$| $$ \  $$|  $$$$$$/| $$  | $$| $$$$$$$$| $$  | $$   | $$   \n");
		m_cvar()->ConsoleColorPrintf(Color(255, 255, 255), "|________/|________/|________/|__/  \__/ \______/ |__/  |__/|________/|__/  |__/   |__/   \n");
		m_cvar()->ConsoleColorPrintf(Color(255, 255, 255), "\n");
		m_cvar()->ConsoleColorPrintf(Color(255, 255, 255), "\n");
	}
